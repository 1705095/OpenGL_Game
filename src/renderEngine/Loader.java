...
public class Loader {
    ...
    private TextureData decodeTextureFile(String fileName) {
        ...
        try {
            ...
            de.matthiasmann.twl.utils.PNGDecoder decoder = new PNGDecoder(in);
            width = decoder.getWidth();
            height = decoder.getHeight();
            buffer = ByteBuffer.allocateDirect(4 * width * height);
            decoder.decode(buffer, width * 4, de.matthiasmann.twl.utils.PNGDecoder.Format.RGBA);  // check here  Format.RGBA
            buffer.flip();
            in.close();
        } catch (Exception e) {
            e.printStackTrace();
